...
$message = "Your details have been successfully entered, a representative will get back to you as soon as possible"; // Your alert message
...
<div class="container mt-3 pt-3 ">
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    <div class="row">
            ...
            <div class="col-xs-6 col-md-6 col-lg-6 ">
            <a href="state_lga.php"><div class="btn btn-primary">goback</div></a>
            </div>
